...
if(isset($_POST['btn'])=='click')
{
    $user=$_POST['user'];
    $pass=$_POST['pass'];
    $sql="select id,fullname,trinig_num , password_mt  from login_member where trinig_num='".$user."' AND password_mt='".$pass."'";
...
$_SESSION['name'] = $row['fullname'];
   ...
   header("Location:index_mt.php");
    }
    
}
//تبع المتدربه تسجيل دخول من القاعده
...
<div class="title">تسجيل دخول</div>
    ...
    <div class="col-3 col-12-medium">
                    ...
                    <input placeholder="******439" type="text" name="user"><br>
                    <input  placeholder="ادخل كلمة المرور" type="password" name="pass"><br>
