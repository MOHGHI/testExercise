...
<form dir="rtl">
  ...
  <div class="form-group">
    ...
    <input type="email" name=""placeholder ="ادخل البريد الالكتروني">
  ...
  <div class="form-group">
    ...
    <input type="password" name=""  placeholder ="ادخل كلمة المرور الجديده">
      
  </div>

      </div><BR>
    <input type="submit" class="button style1" value="ارسال">
    </form>
